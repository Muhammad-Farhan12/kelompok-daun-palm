...
## ⚙️ Metodologi & Alur Kerja Proyek ini dikembangkan dengan pendekatan spec-driven development menggunakan framework GSD Core dan agentic AI (Claude Code). Alur pengembangan kami mengikuti fase:
